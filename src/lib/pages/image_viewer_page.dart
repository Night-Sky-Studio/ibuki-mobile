...
class ImageViewerPage extends HookWidget {
    ...
    Widget build(BuildContext context) {
        ...
        Scaffold buildScaffold(BooruPost image) {
            if (image.isVideo()) {
                player.open(Media(image.largeFileUrl));
                    ...
                    ? Container(
                            ...
                            child: Center(
                                child: Video(
                                    ...
                                    height: image.postInformation.imageHeight?.toDouble(), 
                                    width: image.postInformation.imageWidth?.toDouble(), 
                                    fit: BoxFit.contain,
                                )
                            )
                    )
